...
const SECRET_1 = 'your-secret-key-change-in-production'; // User Service Default / New Inventory Default
...
try {
    ...
    console.log("✅ Verified with SECRET_1 (CORRECT):", decoded1);
} catch (e) {
...
try {
    ...
    console.log("✅ Verified with SECRET_2 (OLD/INCORRECT):", decoded2);
} catch (e) {
